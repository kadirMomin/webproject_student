...
List<Project> myProjects  = pDao.getProjectsByUserName(user);   // onaylı + bekleyen

boolean hasPendingCourse  = courseList.stream().anyMatch(Course::isSelectedByUser);
boolean hasPendingAdvisor = aDao.hasPendingAdvisor(user);
%>
<!DOCTYPE html><html lang="tr"><head>
<meta charset="UTF-8"><title>Ders İşlemleri – ProjectHub</title>
...
.nav-container{display:flex;align-items:center;flex-grow:1;justify-content:flex-end;flex-wrap:wrap}   /* ← sola hizala */
  ...
  <div class="header-container">
    ...
    <div class="nav-container" id="navContainer">
      <ul class="nav-links">
        ...
        <li class="nav-item dropdown">
          <a href="#" class="nav-link"><i class="fas fa-upload"></i><span>Upload</span><i class="fas fa-chevron-down" style="margin-left:5px;font-size:12px;"></i></a>
          <div class="dropdown-menu">
            <a href="upload.jsp"  class="dropdown-item"><i class="fas fa-file-upload" style="width:16px"></i> Proje Yükle</a>
            <a href="courses.jsp" class="dropdown-item"><i class="fas fa-book" style="width:16px"></i> Ders İşlemleri</a>
          </div>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a href="ProfileServlet" class="dropdown-item"><i class="fas fa-user"></i><span>Profile</span></a>
      ...
      <table>
        ...
        %>
          <tr>
            ...
            <td class="<%=c.isSelectedByUser()?"status-selected":"status-not-selected"%>"><%=c.isSelectedByUser()?"✔ Seçildi":"✘ Seçilmedi"%></td>
            <td>
