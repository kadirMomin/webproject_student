...
else                              tableData = java.util.Collections.emptyList();
...
.status-not-selected{color:#dc3545;font-weight:bold}
    ...
    <div class="card">
      ...
      <ul class="list-group">
        <li data-color="success">
          <a href="courses.jsp?view=current">
            <span>Güncel Projeler</span>
            <span class="badge"><%= guncelProjeler %></span>
          </a>
        </li>
        <li data-color="info">
          <a href="courses.jsp?view=mine">
            <span>Yüklenen Projeler</span>
            <span class="badge"><%= benimProjelerim %></span>
          </a>
        </li>
        <li data-color="primary">
          <a href="courses.jsp?view=approved">
            <span>Onaylanan Projeler</span>
            <span class="badge"><%= onaylananProjeler %></span>
          </a>
        </li>
        <li data-color="warning">
          <a href="courses.jsp?view=pending">
            <span>Onay Bekleyen</span>
            <span class="badge"><%= onayBekleyenProj %></span>
          </a>
        </li>
      </ul>
    </div>
      ...
      <table>
        ...
        <% for (Advisor a : advisorList) { %>
          <tr>
            ...
            <td><%= a.getName() %></td>
            <td>
              <a class="btn btn-select" href="AdvisorSelectServlet?id=<%= a.getId() %>"><i class="fas fa-check"></i>Seç</a>
